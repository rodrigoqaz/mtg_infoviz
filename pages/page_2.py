...
if st.session_state.show_analisys_page:
    ...
    st.header('Listar as cartas sem sinergia')
    st.header('Sinergia entre o Commander e seu deck')
    st.header('Grafo dos comnos')
    HtmlFile = open("synergy.html", 'r', encoding='utf-8')
    source_code = HtmlFile.read() 
    components.html(source_code, height = 760)#,width=1000)
    ...
    st.header('Sets no Deck')
    st.header('Quantidade de reprints - cartas com mais reprints')
